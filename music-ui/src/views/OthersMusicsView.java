...
public class OthersMusicsView extends JFrame implements Window {
    public Music m;
    ...
    public void createAndShowUI() {
        ...
        m = new Music(DatabaseController.getInstance().fetchPlaylistSongs(MenuListsController.getInstance().owner,MenuListsController.getInstance().plname), MenuListsController.getInstance().plname + " Created by " + MenuListsController.getInstance().owner);
        ...
        addWindowListener(new WindowAdapter() {
            ...
            public void windowClosing(WindowEvent e) {
                ...
                DatabaseController.choosedLikedName = "";
                dispose();
            }
        });
    }
