...
public class AlbumView extends JFrame implements Window {
    public Music m;
    ...
    public void createAndShowUI() {
        ...
        m = new Music(DatabaseController.getInstance().fetchOtherLikes(), DatabaseController.choosedLikedName + " Liked");
